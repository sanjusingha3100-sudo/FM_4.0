 ...
 * Layout wrapper for owner role pages
 * Includes role-specific navigation and sidebar
 */
export function OwnerLayout({ children, onLogout, onNavigate, currentPage }) {
  const [isOpen, setIsOpen] = useState(false);

  const navItems = [
    { id: 'owner-dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { id: 'owner-fuel-analysis', label: 'Fuel Analysis', icon: Droplet },
    { id: 'owner-sla-reports', label: 'SLA Reports', icon: BarChart3 },
    { id: 'owner-risk-insights', label: 'Risk Insights', icon: TrendingUp },
    { id: 'owner-penalties', label: 'Penalties', icon: AlertTriangle },
    { id: 'owner-settings', label: 'Settings', icon: SettingsIcon },
  ];
        ...
        <div className="p-4 border-t border-slate-700 space-y-3">
          <div className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">Fleet Owner</p>
              <p className="text-xs text-slate-400 truncate">owner@fleet.com</p>
            </div>
